...
export class LEDRasterApp {
    ...
    // Keys are frame rates, values are pixel capacities. Every value that
    // comes from a formula is ROUNDED DOWN (owner, 2026-09-26: "make sure
    // the table values are rounded down") - a pixel over the real limit is
    // a port that does not fit. 5G is NovaStar's published table verbatim,
    // already below its formula.
    portCapacityTables = {
        // NovaStar Armor (MSD/MRV) legacy 1G receiving cards
        // 8-bit uses 24x; 10/12-bit use 48x (max 120 Hz)
        'novastar-armor': {
            8:  { 24:1649305, 25:1583333, 30:1319444, 50:791666, 60:659722, 120:329861 },
            10: { 24:824652,  25:791666,  30:659722,  50:395833, 60:329861, 120:164930 },
            12: { 24:824652,  25:791666,  30:659722,  50:395833, 60:329861, 120:164930 }
        },
        // NovaStar COEX 1G (A10s/A8s Pro) receiving cards
        // 8-bit uses 24x; 10-bit uses 32x; 12-bit uses 48x
        'novastar-coex-1g': {
            8:  { 24:1649305, 25:1583333, 30:1319444, 50:791666, 60:659722, 120:329861, 144:274884, 240:164930 },
            10: { 24:1236979, 25:1187500, 30:989583,  50:593750, 60:494791, 120:247395, 144:206163, 240:123697 },
            12: { 24:824652,  25:791666,  30:659722,  50:395833, 60:329861, 120:164930, 144:137442, 240:82465 }
        },
        ...
        'brompton': {
            8:  { 24:1312500, 25:1260000, 30:1050000, 48:656250, 50:630000, 60:525000, 72:437500, 100:315000, 120:262500, 144:218750, 150:210000, 180:175000, 192:164062, 200:157500, 240:131250, 250:126000 },
            ...
            12: { 24:875000,  25:840000,  30:700000,   48:437500, 50:420000, 60:350000, 72:291666, 100:210000, 120:175000, 144:145833, 150:140000, 180:116666, 192:109375, 200:105000, 240:87500,  250:84000 }
        },
        ...
        'brompton-ull': {
            ...
            12: { 24:437500,  25:420000,  30:350000,  48:218750, 50:210000, 60:175000, 72:145833, 100:105000, 120:87500,  144:72916,  150:70000,  180:58333,  192:54687,  200:52500,  240:43750,  250:42000 }
        },
