...
(function () {
    ...
    var ADVANCED_STEPS = [
        ...
        { target: '[data-mode="power"]', place: 'bottom', title: 'Power view', before: function () { switchView('power'); },
          body: 'Plan electrical distribution. The left panel is this screen&rsquo;s electrical math and styling; the tray holds the <b>distros</b>, and dragging multis and chips is how circuits land on a real Multi 208, Multi 120 or L21-30.' },
        ...
        { target: '#btn-export', place: 'bottom', title: 'Exporting',
          body: 'Pick which <b>canvases</b> and <b>views</b> to output &mdash; Pixel, Cabinet, Show Look, Data and Power maps &mdash; the <b>format</b> (PNG, PSD, PDF, or Resolume XML), a transparent background, and a resolution scale. Exports save straight to file. The <b>Pull Sheet</b> and binder pull gear where its distro or breakout box sits (the <b>Beach</b> picker on the &#9881;, and on each screen in Screen Info &mdash; a project keeps its beaches as a list, in the order the sheets run), and list the CVTs and distros themselves. The <b>Binder</b> is a drawing set: numbered sheets with a title block down the right edge (your logo, the revision log, venue, dates, who drew it), each map a numbered view with its tables beside it, and a <b>Signal + Power</b> sheet per screen wiring every port to its socket and every circuit to its breakout &mdash; Tabloid 17 &times; 11 by default, any sheet size.' },
