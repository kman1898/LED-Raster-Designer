...
(function () {
    ...
    var WHATSNEW_STEPS = [
        ...
        { target: '#hardware-dock-body .hw-dock-multi', place: 'top', title: 'A multi takes what its box has free',
          body: 'Drag a multi over a wall and the span starts at the <b>first circuit</b> of that six and grows to the one under your cursor &mdash; one, then two, then six, in order &mdash; capped at what the box has free: six on an empty soca, three on an L21-30, less whatever is already on it. Short, it says <b>took 5 of 6</b>. Clear a multi and the wall welds back to its natural six-per-box grid; one undo restores it all.' },
        { target: '#hardware-dock-body .hw-dock-typechip', place: 'top', title: 'A box wears its type',
          body: 'Every multi box carries a chip &mdash; <b>Soca 208</b>, <b>Soca 120</b>, <b>L21-30</b>. On the spare box the chip is the picker: click it to cycle, drag that box onto a screen and it lands as that plug. An occupied box reads the type its circuits imply, and a spare box follows the distro&rsquo;s other boxes, so an Edison distro&rsquo;s next box is Edison without a click.' },
        { target: '#hardware-dock-body .hw-dock-outputs', place: 'top', title: 'OUTPUTS: the plugs you drag',
          body: 'Tick the connector types a distro offers behind its &#9881; and each becomes a plug on this row. Drag one onto a screen: the circuits the drop will feed light up with a pending bracket and a pill &mdash; <b>SL 3 &rarr; circuits 7-12 &middot; 81 A</b>. A screen set to a different breakout refuses with the reason, and the pill warns when the box would push the distro&rsquo;s legs past rating.' },
        { target: '#hardware-dock-body .hw-dock-tile', place: 'top', title: 'Three grains, three clears',
          body: 'Right-click a circuit chip (or drag it back onto the tray) and <b>Clear circuit SR1-6</b> takes that one circuit off the multi; the other five stay put and keep their labels. The box header clears the whole multi, and the distro clears everything. Chip = circuit, header = multi, distro = the lot.' },
        { target: '#hardware-dock-body .hw-dock-multi', place: 'top', title: 'Every circuit carries its cable',
          body: 'The multi&rsquo;s name and its one home-run length live on its header. On a box with circuits on it, a raised <b>&#8801;</b> flips the chips into a cable sheet &mdash; a row per circuit with its screen, <b>feet</b> and <b>connector</b>, <b>Tab</b> walking the column, quick fills for the whole box and a count by length and connector at the foot. The connector follows the box, so mostly you type a number; a chip wears its cable in its corner when the sheet is closed.' },
    ...
    var ADVANCED_STEPS = [
        ...
        { target: '[data-mode="power"]', place: 'bottom', title: 'Power view', before: function () { switchView('power'); },
          body: 'Plan electrical distribution. The left panel is this screen&rsquo;s electrical math and styling; the tray holds the <b>distros</b>, and dragging multis and chips is how circuits land on real boxes.' },
        ...
        { target: '#power-distro-add', place: 'bottom', title: 'Distros &amp; multis',
          body: '<b>+ Add distro</b> puts a power source in the tray. Drag a <b>multi</b> over a wall and it takes from the <b>first circuit</b> of that six up to the one under your cursor, capped at what the box has free (<b>took 5 of 6</b> when short); clearing a multi welds the wall back to its six-per-box grid. Every box wears its connector as a <b>type chip</b> &mdash; Soca 208, Soca 120, L21-30 &mdash; click the spare box&rsquo;s chip to pick, and the box lands as that plug; the distro&rsquo;s <b>OUTPUTS</b> row holds the same plugs with a live drop preview. Drag a whole distro onto a screen to feed all its unassigned multis at once.' },
        { target: '#hardware-dock-body [data-hwdock^="slot-"]', place: 'top', title: 'One soca, two screens',
          body: 'Drop a multi onto an <b>occupied</b> box and they become one physical soca: same distro, same number. The incumbents keep their circuits, the joiner takes the free ones, and every label derives from the one box name.' },
