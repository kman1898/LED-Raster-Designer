...
(function () {
    ...
    var WHATSNEW_STEPS = [
        ...
        { target: '#hardware-dock-body .hw-dock-multi', place: 'top', title: 'A multi takes what is free',
          body: 'Drag a multi over a wall and the span starts at the <b>first circuit</b> of that six and grows to the one under your cursor &mdash; one, then two, then six, in order &mdash; capped at what is free: six on an empty Soca 208, three on an L21-30, less whatever is already on it. Short, it says <b>took 5 of 6</b>. Clear a multi and the wall welds back to its natural six-circuit grid; one undo restores it all.' },
        { target: '#hardware-dock-body .hw-dock-typechip', place: 'top', title: 'The type chip',
          body: 'Every number on the tray carries a chip &mdash; <b>Soca 208</b>, <b>Soca 120</b>, <b>L21-30</b>. On the spare one the chip is the picker: click it to cycle, drag it onto a screen and it lands as that plug. Occupied, the chip reads the type its circuits imply; spare, it follows the distro&rsquo;s others, so an Edison distro&rsquo;s next number is a Soca 120 without a click.' },
    ...
    var ADVANCED_STEPS = [
        ...
        { target: '[data-mode="power"]', place: 'bottom', title: 'Power view', before: function () { switchView('power'); },
          body: 'Plan electrical distribution. The left panel is this screen&rsquo;s electrical math and styling; the tray holds the <b>distros</b>, and dragging multis and chips is how circuits land on a real Soca 208, Soca 120 or L21-30.' },
        ...
        { target: '#hardware-dock-body .hw-dock-tile', place: 'top', title: 'Circuit chips',
          body: 'Each circuit is a chip and every chip is a meter of its circuit&rsquo;s load. Click an occupied chip to rename that circuit; right-click it for <b>Clear circuit</b>, which takes that one circuit off and leaves the other five (the header clears the multi, the distro clears everything). A clash (two claims on one circuit) is said out loud on the chip and in the issue rows.' },
        ...
        { target: '#btn-export', place: 'bottom', title: 'Exporting',
          body: 'Pick which <b>canvases</b> and <b>views</b> to output &mdash; Pixel, Cabinet, Show Look, Data and Power maps &mdash; the <b>format</b> (PNG, PSD, PDF, or Resolume XML), a transparent background, and a resolution scale. Exports save straight to file. The <b>Pull Sheet</b> and binder pull gear where its distro or breakout box sits (<b>Location</b> on the &#9881;), and list the CVTs and distros themselves. The <b>Binder</b> is a drawing set: numbered sheets with a title block down the right edge (your logo, the revision log, venue, dates, who drew it), each map a numbered view with its tables beside it &mdash; Tabloid 17 &times; 11 by default, any sheet size.' },
