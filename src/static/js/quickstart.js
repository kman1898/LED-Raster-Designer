...
(function () {
    ...
    var WHATSNEW_STEPS = [
        ...
        { target: '#hardware-dock-body .hw-dock-gear', place: 'top', title: 'Configuration behind the &#9881;',
          body: 'Each header&rsquo;s <b>&#9881;</b> opens its settings popover: card slots, breakout boxes, label templates, remove. <b>Redundancy</b> is set behind the <b>processor&rsquo;s</b> &#9881; only, at three levels: the whole processor mirrored by another, per card, or per port.' },
        ...
        { target: '[data-mode="power"]', place: 'bottom', title: 'Power works the same way', before: function () { switchView('power'); },
          body: 'Distros sit in the tray with their multis. Drag a <b>multi</b> onto a circuit to land it &mdash; drop on a later circuit and the multi <b>splits there</b>; the drop is the boundary. Drag one chip to put a single circuit on one circuit of the box.' },
    ...
    var ADVANCED_STEPS = [
        ...
        { target: '#hardware-dock-body .hw-dock-gear', place: 'top', title: 'The &#9881; popover',
          body: 'Each header&rsquo;s <b>&#9881;</b> holds its configuration: label and return templates, card slots and breakout boxes. <b>Redundancy</b> is set behind the <b>processor&rsquo;s</b> &#9881;.' },
        { target: '#hardware-dock-body .hw-dock-gear', place: 'top', title: 'Redundancy, three levels',
          body: 'Behind the processor&rsquo;s &#9881;: switch redundancy on, then pick the level. <b>Whole processor</b> &mdash; another unit mirrors this one, card for card. <b>Per card</b> &mdash; <b>1:1</b>, this card mirrored by another card. <b>Per port</b> &mdash; <b>Sequential</b> (1 backed by 2, 3 by 4), <b>Halves</b> (the back half carries the front half&rsquo;s returns), or <b>Manual</b> (each port picks its backup on its chip).' },
