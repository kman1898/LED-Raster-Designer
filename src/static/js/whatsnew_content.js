...
window.WHATS_NEW_CONTENT = {
    '0.12': {
        ...
        items: [
            ...
            { h: 'Ports snake',
              d: 'Hold Alt and sweep the port chips of one card or box, then right-click Snake these N - or tick them in the card’s cable sheet and press Snake. A snake reads as a blue bracket (SNAKE A · 6-way · 100’) under its ports, a loose port carries its own length, a snaked port can carry an ext length for a shorter extension off the fan-out, and a backup port’s run is typed on the backup card’s or box’s own sheet and counted on the papers. The papers pull gear where its distro or breakout box sits (Location on the gear) and list the CVTs and distros themselves. The Data panel’s Show Cable Tags prints them on the wall. The binder is a drawing set now: numbered sheets by subject (1.x overview, 2.x power, 3.x data, 4.x pull, 5.x hardware) with a title block down the right edge - revisions, notes, venue, dates, designer, project manager, drafter - each map a numbered view with its tables beside it, on Tabloid 17 x 11 by default or any sheet size, the text real text in the PDF.' }
        ]
    },
    '0.11': {
        title: 'Screen groups',
